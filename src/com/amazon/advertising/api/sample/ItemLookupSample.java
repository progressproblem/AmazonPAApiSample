...
public class ItemLookupSample {
     ...
     */
    private static final String AWS_ACCESS_KEY_ID = "XXXXXXXXXXXXXXXXXXXXXXXXXX";

    /*
     * Your AWS Secret Key corresponding to the above ID, as taken from the AWS
     * Your Account page.
     */
    private static final String AWS_SECRET_KEY = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXr";

    private static final String ASSOCIATE_ID = "XXXXXXXXXXXXXXXXXXXXXX";
    ...
    public static void main(String[] args) {
        ...
        try {
            helper = SignedRequestsHelper.getInstance(ENDPOINT, AWS_ACCESS_KEY_ID, AWS_SECRET_KEY, ASSOCIATE_ID);
        } catch (Exception e) {
            e.printStackTrace();
            return;
        }
